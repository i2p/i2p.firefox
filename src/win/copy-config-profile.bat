...
if (exist "%LOCALAPPDATA%\I2PBrowser-Launcher\firefox.profile.config.i2p\") (
  ...
  xcopy /s /i /y "%I2PData%\I2PBrowser-Launcher\firefox.profile.config.i2p\extensions" "%LOCALAPPDATA%\I2PBrowser-Launcher\firefox.profile.config.i2p\extensions"
) else (
  echo "configuring profile"
  xcopy /s /i /y "%I2PData%\I2PBrowser-Launcher\firefox.profile.config.i2p" "%LOCALAPPDATA%\I2PBrowser-Launcher\firefox.profile.config.i2p"
)
